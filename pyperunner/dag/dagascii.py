...
functions. The original file can be found here:
 https://github.com/iterative/dvc/blob/fcdb503b4eff1297e5c1c1ed18f5606fe780e481/dvc/dagascii.py
"""
...
class VertexViewer:
    ...
    @property
    def w(self) -> int:  # pylint: disable=invalid-name
        """Width of the box."""
        return self._w
...
def _build_sugiyama_layout(
    vertexes: Union[List, Dict, ValuesView], edges: List
) -> SugiyamaLayout:
    #
...
def draw(vertexes: List, edges: List) -> str:
